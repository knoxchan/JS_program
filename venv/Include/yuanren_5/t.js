...
pr = [
    "e4978a2b0ededb51fd6a0c7cbc6ba6f7",
    "e68800b754c248f420b731cd7a5b80f3",
    "d13fdb6bd929387679ff1ef473aee98a",
    "a3b76a3ef97deb1b3a06008c66d331f5",
    "6c550558746516a8773540f2be91b92d"
]
...
function time_encode(timestamp2) {
    return _0x499969(_0x41873d(timestamp2));
}
...
// 不带毫秒的 时间
timestamp2 = Date.parse(new Date()).toString();

console.log(time_encode(timestamp2))


qf = CryptoJS['enc']['Utf8']['parse'](btoa(timestamp2)['slice'](0x00, 0x10));

ww = CryptoJS['enc']['Utf8']['parse'](pr.toString())
// console.log(ww)

ss = CryptoJS['AES']['encrypt'](ww, qf, {
