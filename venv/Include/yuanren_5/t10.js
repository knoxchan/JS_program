...
_0x4e96b4 = {}
$_zw = [10864, 'NTEyMDAsNTE0NTYsNTE3MTIsNTE5NjgsNTIyMjQsNTI0ODAsNT…4ODgzMiwxNjg5MDg4LDE2ODkzNDQsMTY4OTYwMCwxNjg5ODU2', '51200,51456,51712,51968,52224,52480,52736,52992,53…0,1688576,1688832,1689088,1689344,1689600,1689856', 1081, 1081, true, '明说了，这个数组是指纹', 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 1633879662000, 1633879663000, 123]
...
function get_cookie_m(_$Wa) {
    // _$Wa = _0x12eaf3();
    $_zw[23] = 16338816222000
    $_zw[24] = String(parseInt(_$Wa) + 1000 )
    return _0x474032(_$Wa) + ';\x20path=/';
}

console.log(get_cookie_m('1633881669000'))
